...
int main() {
    ...
    while(1) {
        ...
        randomNumber(sort);
        printf("번호 입력 : "); scanf(" %d", &ticket);

        switch(ticket) {
            case 1:
                printf("<선택정렬>\n");
                printf("정렬 전 : "); sort->print(sort); printf("\n"); 
                sort->selectSort(sort);
                printf("정렬 후 : "); sort->print(sort);
                break;
            ...
            case 4:
                printf("<빠른정렬>\n");
                printf("정렬 전 : "); sort->print(sort); printf("\n"); 
                sort->quickSort(sort, sort->startIndex, sort->lastIndex);
                printf("정렬 후 : "); sort->print(sort);
                break;
            ...
            case 5:
                printf("<합병정렬>\n");
                printf("정렬 전 : "); sort->print(sort); printf("\n"); 
                sort->mergeSort(sort, sort->startIndex, sort->lastIndex);
                printf("정렬 후 : "); sort->print(sort);
                break;
